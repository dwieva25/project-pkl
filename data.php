        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                 ...
                 <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1">Tahun 2021</button>
                 <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1">Tahun 2022</button>
                 <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal1">Tahun 2023</button>  
                  </div>                
