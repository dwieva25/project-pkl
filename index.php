...
<div class="header">
	...
	<div class="banner-agile-top">
		...
		<div class="logo">
			<h1><a href="index.html">Dinas Komunikasi, Informatika dan<span> Statistik Kota Denpasar</span></a></h1>
		</div>
		<!-- navigation -->
		<div class="top-left">
			<div class="top-nav">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						 <nav class="linkEffects linkHoverEffect_2">
							<ul>
								...
								<li><a href="#about" data-link-alt="About us" class="scroll"><span>About us </span></a></li> 
								<li><a href="#services" data-link-alt="services" class="scroll"><span>Sejarah</span></a></li> 
	...
	<!--Slider-->
				...
				<ul class="rslides" id="slider">
					<li>
						<div class="slider-info">
							<h3>HELLO WELCOME DEAR ! Hopefully U're enjoy with our services </h3>
						    <p>if U need help , may i can help U?
						    </p>
							<div class="readmore-w3">
								<a class="btn btn-primary" id="searchDropdown"  type="button" href="login.php" da>Go!</a>
							</div>
						</div>
					</li>
					<!-- informations room terdapat informasi kamar yang akan dijelaskan -->
					<li>
						<div class="slider-info1">
							<h3>KOMINFO KOTA DENPASAR</h3>
							<p>Guest comfort is our priority.</p>
							<div class="readmore-w3">
								<a class="btn btn-primary" id="searchDropdown"  type="button" href="login.php" da>Go!</a>
							</div>
						</div>
					...
					<li>
						<div class="slider-info2">
							<h3>KOMINFO KOTA DENPASAR</h3>
							<p>Guests are comfortable and happy, we are happy.</p>
							<div class="readmore-w3">
								<a class="btn btn-primary" id="searchDropdown"  type="button" href="login.php" da>Go!</a>
							</div>
						</div>
		...
		<div class="modal fade" id="myModal1" tabindex="-1" role="dialog">
						<!-- Modal1 -->
							...
							<!-- disini terdapat deskripsi tentang HOTEL-->
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
										<h4>Our DEL LUNA hotel</h4>
										<img src="images/popup.jpg" alt=" " class="img-responsive"/>
										<p>DEL LUNA HOTEL memiliki fasilitas Room yang sangat memadai sehingga tamu dapat beristirahat dengan nyaman dan aman, para tamu dapat menggunakan fasilitas hotel 24 jam</p>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="w3-agile-about-grids">
		<div class="w3-aglie-about-grid1">
			<div class="col-md-6 w3-about-text-grid">
				<h3>About DEL LUNA HOTEL</h3>
				<p>DEL LUNA HOTEL telah berdiri sejak tahun 2009 meski masih terbilang baru fasilitas dan pelayanan kami akan memastikan para tamu yang menginap memiliki kesan yang mendalam sehingga tamu akan merasa nyaman</p>
		...
		<div class="w3-agile-grids">
			<div class="col-md-6 w3-agile-services-left">
				...
				<ul class="services-head">
					...
					<h2><p>Servis yang kami tawarkan,anda dapat menggunakan service tersebut : </p></h2>
				</div>
				<!-- untuk icon service -->
				
				<div class="col-md-4 services-icon1">
					<img src="images/service.PNG" alt="image" height ="100" width ="120">
			...
			<div class="col-md-6 w3-agile-services-right">
				<img src="images/ab2.jpg" alt="services">
				<h1>Loundry Service</h1>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
	...
	<div id="review" class="jarallax reviews agile-1" >
				<div class="w3-agile-test-monials" id="testimonials">
					<div class="client-review-head">
						<h3>If u wanna see the room type you can klik Room , enjoy!</h3>
						<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list" >
					<li class="resp-tab-item"><span><a href="room.php">ROOM TYPE</a></span></li>
					<li class="resp-tab-item"><span><a href="formbooking.php">BOOKING</a></span></li>
...
<div class="contact" id="contact">
		<div class="map">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12107.26650393514!2d-112.05321904089281!3d40.6559724368103!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x35a5211d879631be!2sHexcel+Corporation!5e0!3m2!1sen!2sin!4v1491470367982"></iframe>
					...
					<div class="agileinfo_map_color_grid">
						<div class="col-md-6 contact-up">
							<div class="agileinfo_map_color_grid_left">
								<h4>Contact us</h4>
							<p>123 san francisco <span>New York City USA</span></p>
							<p>+00 1111 222</p>
							<p>+12 322 3333</p>
...
<!--footer-->
<div class="footer-w3">
	<p>&copy;DEL LUNA HOTEL. All rights reserved | copyright @2009 yunia's project</a></p>
</div>
<!--//footer-->
